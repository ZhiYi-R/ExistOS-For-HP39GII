/**
 * @file Bootloader/Hal/Hardware/registers/regsbch.h
 * @brief regsbch module
 */
...
#define HW_BCH_CTRL_SET_ADDR  (REGS_BCH_BASE + 0x00000004)
#define HW_BCH_CTRL_CLR_ADDR  (REGS_BCH_BASE + 0x00000008)
#define HW_BCH_CTRL_TOG_ADDR  (REGS_BCH_BASE + 0x0000000C)
...
#define BF_BCH_FLASH0LAYOUT1_ECCN(v)   (((v) << 12) & BM_BCH_FLASH0LAYOUT1_ECCN)
...
#define BF_BCH_FLASH1LAYOUT0_ECC0(v)   (((v) << 12) & BM_BCH_FLASH1LAYOUT0_ECC0)
...
#define BF_BCH_FLASH1LAYOUT1_ECCN(v)   (((v) << 12) & BM_BCH_FLASH1LAYOUT1_ECCN)
...
#define BF_BCH_FLASH2LAYOUT0_ECC0(v)   (((v) << 12) & BM_BCH_FLASH2LAYOUT0_ECC0)
...
#define BF_BCH_FLASH2LAYOUT1_ECCN(v)   (((v) << 12) & BM_BCH_FLASH2LAYOUT1_ECCN)
...
#define BF_BCH_FLASH3LAYOUT0_ECC0(v)   (((v) << 12) & BM_BCH_FLASH3LAYOUT0_ECC0)
...
#define BF_BCH_FLASH3LAYOUT1_ECCN(v)   (((v) << 12) & BM_BCH_FLASH3LAYOUT1_ECCN)
...
////////////////////////////////////////////////////////////////////////////////
//// HW_BCH_DEBUG0 - Hardware ECC 8 Debug Register0
////////////////////////////////////////////////////////////////////////////////
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned ROM_BIST_COMPLETE          :  1;
        unsigned ROM_BIST_ENABLE            :  1;
        unsigned RSVD1                      :  5;
    } B;
} hw_bch_debug0_t;
#endif
...
#define HW_BCH_DEBUG0_SET_ADDR  (REGS_BCH_BASE + 0x00000104)
#define HW_BCH_DEBUG0_CLR_ADDR  (REGS_BCH_BASE + 0x00000108)
#define HW_BCH_DEBUG0_TOG_ADDR  (REGS_BCH_BASE + 0x0000010C)
...
//--- Register HW_BCH_DEBUG0, field ROM_BIST_ENABLE

#define BP_BCH_DEBUG0_ROM_BIST_ENABLE      26
#define BM_BCH_DEBUG0_ROM_BIST_ENABLE      0x04000000

#define BF_BCH_DEBUG0_ROM_BIST_ENABLE(v)   (((v) << 26) & BM_BCH_DEBUG0_ROM_BIST_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_BCH_DEBUG0_ROM_BIST_ENABLE(v)   BF_CS1(BCH_DEBUG0, ROM_BIST_ENABLE, v)
#endif

//--- Register HW_BCH_DEBUG0, field ROM_BIST_COMPLETE

#define BP_BCH_DEBUG0_ROM_BIST_COMPLETE      25
#define BM_BCH_DEBUG0_ROM_BIST_COMPLETE      0x02000000

#define BF_BCH_DEBUG0_ROM_BIST_COMPLETE(v)   (((v) << 25) & BM_BCH_DEBUG0_ROM_BIST_COMPLETE)

#ifndef __LANGUAGE_ASM__
#define BW_BCH_DEBUG0_ROM_BIST_COMPLETE(v)   BF_CS1(BCH_DEBUG0, ROM_BIST_COMPLETE, v)
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// HW_BCH_DBGAHBMREAD - AHB Master and ecc8 controller Debug Read Register
////////////////////////////////////////////////////////////////////////////////
